...
- (void) createStackPanelContents {
    ...
    [_binder bindProperty:@"StackVisibility" withBoolStateOfCell:subStackPanel actionType:(WPLBoolStateActionTypeVISIBLE_INVISIBLE) negation:false bindingMode:(WPLBindingModeSOURCE_TO_VIEW) customActin:nil];
